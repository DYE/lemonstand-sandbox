<?
	 ...
	 * This field can be used for customize the order list on the {@link http://lemonstandapp.com/docs/customer_orders_page Customer Orders} page.
	 * @property boolean $notify_customer Determines whether a customer should be notified when an order gets into this status.
	 * @property boolean $notify_recipient Determines whether LemonStand users responsible for processing orders with this status should be notified when an order gets into this status.
	 * @documentable
	 * @see http://lemonstandapp.com/docs/configuring_the_order_route_and_user_roles Configuring the order route and user roles
	 * @see Shop_Order
	...
	class Shop_OrderStatus extends Db_ActiveRecord
	{
		...
		/**
		 * Allows to cancel the internal user notification when an object changes its status.
