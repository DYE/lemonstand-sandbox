<?php
	...
	class Shop_ExtraOption extends Db_ActiveRecord
	{
		 ...
		 * {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ tax inclusive settings}. 
		 * Example:
		 * <pre>
		 ...
		 * {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ tax configuration}.
		 * @documentable
		 * @param Shop_Product $product Specifies a product the extra option belongs to.
		 * @return float Returns the extra option price.
		 */
...
//			$this->option_key = md5($this->id);
		 ...
		 * To add new columns to the customer model, call the {@link Db_ActiveRecord::define_column() define_column()}
		 ...
		 */
		private function event_onExtendCustomerModel($extra_option) {}
		 ...
		 */
		private function event_onExtendExtraOptionForm($customer, $context) {}
