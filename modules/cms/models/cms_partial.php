<?php
	...
	/**
	 * Represents a CMS {@link http://lemonstandapp.com/docs/creating_a_partial/ partial}.
	...
	class Cms_Partial extends Cms_Object
	{
		 ...
		 * Please note that the method finds partials in context of the currently active {@link http://lemonstandapp.com/docs/themes/ theme}.
		 * @documentable
		 ...
		 * <li><em>file_name</em> - path to the partial file (if {@link http://lemonstandapp.com/docs/using_file_based_templates/ file-based templates mode} is enabled).</li>
