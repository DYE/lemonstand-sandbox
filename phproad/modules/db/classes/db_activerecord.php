<?
	 ...
	 * </pre>
	 *
	 * @see http://lemonstandapp.com/docs/working_with_the_database/ Working with the database
	 * @documentable
	...
	class Db_ActiveRecord extends Db_SqlBase implements IteratorAggregate
	{
		 ...
		 * Please read {@link http://lemonstandapp.com/docs/creating_data_relations/ Creating data relations}
		 * article for details.
		 * @documentable
		 */
		public $has_one;
...
//			$this->column_definition_context = $form_context;
		...
		/**
		 * Returns a list of {@link http://lemonstandapp.com/docs/creating_data_relations/ relation} objects, taking into account deferred relations.
...
//			$context = $context ? $context : $this->column_definition_context;
		...
		/**
		 * Adds column definition for <em>has_on</em> or <em>belongs_to</em> {@link http://lemonstandapp.com/docs/creating_data_relations/ relation} field.
		...
		/**
		 * Adds column definition for <em>has_and_belongs_to_many</em> or <em>has_many</em> {@link http://lemonstandapp.com/docs/creating_data_relations/ relation} field.
		 * You should define columns for a relation field if you want the field to be displayed in lists or forms. The method
		 ...
		 * a partial with name _form_section_<em>em</em>.htm in the controller's views directory,
		 * where <em>id</em> is an area identifier specified in the method parameter.
		 * @documentable
		 ...
		 * }
		 * </pre>
		 * @see http://lemonstandapp.com/docs/administration_area_lists/ Lists
		 * @see http://lemonstandapp.com/docs/administration_area_forms/ Forms
		 * @documentable
		 ...
		 * {@link http://lemonstandapp.com/docs/lemonstand_configuration_options/ configuration option} is enabled. </span>
