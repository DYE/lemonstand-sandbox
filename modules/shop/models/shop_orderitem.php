<?php
	 ...
	 * with order item objects on {@link http://lemonstandapp.com/docs/order_details_page Order Details page} and
	 * {@link http://lemonstandapp.com/docs/payment_receipt_page/ Payment Receipt} pages.
	 ...
	 * @property Db_DataCollection $uploaded_files A collection of files uploaded by the customer on the {@link http://lemonstandapp.com/docs/supporting_file_uploads_on_the_product_page/ Product Details} page. 
	...
	class Shop_OrderItem extends Db_ActiveRecord
	{
		 ...
		 * uses the {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ tax inclusive settings}.
		 ...
		 * {@link http://lemonstandapp.com/docs/order_details_page Order Details page} or 
		 * {@link http://lemonstandapp.com/docs/payment_receipt_page/ Payment Receipt} page to output 
		 ...
		 * Below is an event handler example. Similar code used in the {@link http://lemonstandapp.com/docs/subscriptions_module Subscriptions Module}: 
		 * <pre>
		 * public function subscribeEvents()
		 * {
