<?
	 ...
	 * dimensions and weight of the cart items. Please read the {@link http://lemonstandapp.com/docs/cart_page/ Creating the Cart page} article for examples of 
	 * the class usage.
	 * 
	...
	class Shop_Cart
	{
		 ...
		 * @param array $custom_data Contains item {@link http://lemonstandapp.com/docs/allowing_customers_to_provide_order_item_specific_information/ custom fields} data.
		 ...
		 *   <li><em>custom_data</em> - an array of {@link http://lemonstandapp.com/docs/allowing_customers_to_provide_order_item_specific_information/ custom API field} names and values.</li>
		 *   <li><em>bundle_data</em> - an array containing {@link http://lemonstandapp.com/docs/displaying_product_bundle_items/ bundle product data}.</li>
		...
		protected static function check_availability($product, $total_quantity, $options, $option_keys)
		{
...
//						self::remove_item($item->key, $cart_name);
		 ...
		 * {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ Display catalog/cart prices including tax} 
		 * feature is enabled.
		 * @documentable
		 * @param string $cart_name Specifies the cart name.
		 ...
		 * {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ front-end taxes} are enabled.
		 ...
		 * event is triggered. Please read {@link http://lemonstandapp.com/docs/allowing_visitors_to_customize_products/ this article} to 
		 ...
		 * @see http://lemonstandapp.com/docs/allowing_visitors_to_customize_products/ Allowing visitors to customize products
		 * @see shop:onBeforeAddToCart
		 * @see shop:onAfterAddToCart
		 * @package shop.events
		 * @author LemonStand eCommerce Inc.
		 ...
		 * @see http://lemonstandapp.com/docs/allowing_customers_to_provide_order_item_specific_information/ Allowing customers to provide order item specific information
		 * @see shop:onPreProcessProductCustomData
		 * @see shop:onAfterAddToCart
		 * @package shop.events
		 * @author LemonStand eCommerce Inc.
		 ...
		 * @param array $options An array of product options.
		 * @param array $extra_options An array of product extra options.
		 * @param array $custom_data An associative array of {@link http://lemonstandapp.com/docs/allowing_customers_to_provide_order_item_specific_information/ custom field} names and values.
		 * @param array $bundle_data Bundle data associated with the product.
		 * @param array $master_bundle_data Master bundle data associated with the product.
		 */
