<?
	...
	class Shop_CheckoutData
	{
		 ...
		 * it can be loaded from the {@link http://lemonstandapp.com/docs/configuring_the_shipping_parameters/ default shipping location}.
		 * @documentable
		 * @see http://lemonstandapp.com/docs/configuring_the_shipping_parameters/ Shipping Configuration
		 ...
		 * @documentable
		 * @see http://lemonstandapp.com/docs/creating_shipping_method_partial/ Creating the Shipping Method partial
...
//			$goods_tax = Shop_Cart::eval_goods_tax(Shop_CheckoutData::get_shipping_info(), null, $cart_name);
		 ...
		 * in {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ tax inclusive environments}.
		 ...
		 * @documentable
		 * @see http://lemonstandapp.com/docs/skipping_the_shipping_method_step_for_downloadable_products_or_services/ Skipping the Shipping Method step for downloadable products or services
		 * @param string $cart_name Specifies the shopping cart name
