	...
	jQuery.ui.grid.editors.popupEditor = jQuery.Class.create(jQuery.ui.grid.editors.editorBase, {
		...
		bindPopupTrigger: function(cell, columnInfo, rowDataIndex) {
			...
			cell.bind('click', function(){
				...
				self.buildPopup(cell, columnInfo, rowDataIndex);
		...
		buildPopup: function(cell, columnInfo, rowDataIndex) {
			var 
			...
			new Request.Phpr({
				...
				onSuccess: function() {
					self.displayPopup(tmp, zIndex, cell, grid);
				},
		...
		displayEditor: function(cell, navigationDirection, selectAll, columnInfo) {
			...
			if (columnInfo.editor_class !== undefined) {
				...
				button.click(function(){
					self.hideEditor(cell, editor);
					self.buildPopup(cell, columnInfo, cell.data('grid.rowDataIndex'));
					return false;
				});
