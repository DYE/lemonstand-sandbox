<?php
	...
	class Cms_Page extends Cms_Object
	{
		 ...
		 * @see http://lemonstandapp.com/docs/creating_site_maps_dynamic_menus_and_breadcrumbs/ Creating site maps, dynamic menus and breadcrumbs
		 * @documentable
		 */
		 ...
		 * {@link http://lemonstandapp.com/docs/using_file_based_templates/ file-based templates mode}
		 * is enabled.</span>
		 * @documentable
		 */
		public $content;
		 ...
		 * Please note that the method finds pages in context of the currently active {@link http://lemonstandapp.com/docs/themes/ theme}.
		 *
		 ...
		 * This method allows to find a page which uses a specific {@link http://lemonstandapp.com/docs/actions/ action}.
		 * Please note that the method finds pages in context of the currently active {@link http://lemonstandapp.com/docs/themes/ theme}.
		...
		/**
		 * Returns content of a {@link http://lemonstandapp.com/docs/creating_editable_blocks/ content block} content by its code.
		...
		/**
		 * Allows to hide a page from {@link http://lemonstandapp.com/docs/creating_site_maps_dynamic_menus_and_breadcrumbs automatically generated menus and site maps}.
		...
		/**
		 * Triggered after a page has been duplicated with Duplicate {@link http://lemonstandapp.com/docs/themes/ Theme} feature.
		 ...
		 * <li><em>path</em> - path to the page file (if {@link http://lemonstandapp.com/docs/using_file_based_templates/ file-based templates mode} is enabled).</li>
		 * <li><em>file_based</em> - boolean, determines whether {@link http://lemonstandapp.com/docs/using_file_based_templates/ file-based templates mode} is enabled.</li>
		 * </ul>
