<?
	 ...
	 * @see Shop_Order
	 * @see http://lemonstandapp.com/docs/checkout_page Checkout page
	 ...
	 * @see http://lemonstandapp.com/docs/developing_payment_modules Developing payment modules
	 * @package shop.models
	...
	class Shop_PaymentMethod extends Db_ActiveRecord
	{
		 ...
		 * This method is used inside the {@link http://lemonstandapp.com/docs/pay_page payment page}.
		 * @documentable
		 * @see http://lemonstandapp.com/docs/pay_page Payment page
		 ...
		 * This method is used inside the {@link http://lemonstandapp.com/docs/implementing_customer_payment_profiles payment proile page}.
		 * @documentable
		 * @see http://lemonstandapp.com/docs/implementing_customer_payment_profiles Payment profile page
		 * @param Cms_Controller $controller A CMS controller object.
		 */
