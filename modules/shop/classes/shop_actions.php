<?php
	...
	class Shop_Actions extends Cms_ActionScope
	{
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/category_pag Product Category} page. 
		 ...
		 * @see http://lemonstandapp.com/docs/category_page Creating the Category Page
		 */
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/product_page Product Details} page. 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/product_page Product Details page
		 ...
		 * This AJAX handler can be used on the {@link http://lemonstandapp.com/docs/product_page Product Details} page or on any other page.
		 ...
		 * This field is not required if the handler used on the {@link http://lemonstandapp.com/docs/product_page Product Details} page.
		 * Example: 
		 * <pre>
		 * <input onclick="return $(this).getForm().sendRequest(
		 *   'shop:on_addToCart',
		 ...
		 * </pre>
		 * 
		 * @see http://lemonstandapp.com/docs/product_page Product page
		 * @see http://lemonstandapp.com/docs/cart_page Creating the Cart page
		 ...
		 * {@link http://lemonstandapp.com/docs/displaying_product_rating_and_reviews Displaying product rating and reviews} 
		 ...
		 * This field is optional if the review form is implemented on the {@link http://lemonstandapp.com/docs/product_page Product Details}
		 * page.
		 ...
		 * 
		 * @see http://lemonstandapp.com/docs/displaying_product_rating_and_reviews Displaying product rating and reviews
		 * @see http://lemonstandapp.com/docs/product_page Product Details page
		 * @see action@shop:product
		 * @author LemonStand eCommerce Inc.
		 * @package shop.ajax handlers
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/cart_page Cart} page. 
		 ...
		 * @output float $discount A discount value, calculated using the price rules, defined on the {@link http://lemonstandapp.com/docs/shopping_cart_price_rules/ Shop/Discounts page} in the Administration Area. 
		 ...
		 * If the {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ Display catalog/cart prices including tax} feature 
		 * is enabled, this variable value will match the <em>$cart_total</em> variable value.
		 * @output gloat $cart_tax A total tax amount for all cart items.
		...
		/**
		 * Allows to add the <em>Estimate shipping cost</em> feature to the {@link http://lemonstandapp.com/docs/cart_page Cart page}. 
		 * Usually this AJAX handler used on the {@link http://lemonstandapp.com/docs/cart_page Cart page} together with {@link action@shop:cart} action.
		 * 
		 ...
		 * Please read the {@link http://lemonstandapp.com/docs/implementing_the_shipping_cost_estimator_feature Implementing the Shipping Cost Estimator Feature article} 
		 * for more information.
		 *
		 * @ajax shop:on_evalShippingRate
		 * @see http://lemonstandapp.com/docs/implementing_the_shipping_cost_estimator_feature Implementing the Shipping Cost Estimator Feature
		 * @see http://lemonstandapp.com/docs/cart_page Cart page
		 * @see action@shop:cart
		 * @package shop.ajax handlers
		 * @author LemonStand eCommerce Inc.
		 */
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/customer_login_and_logout Login} page. 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/customer_login_and_logout Customer Login and Logout
		 * @see http://lemonstandapp.com/docs/customer_registration_page Customer registration page
		 */
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/customer_registration_page Customer Signup} page.
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/customer_registration_page Customer Signup page
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/password_restore_page Password Restore} page. 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/password_restore_page Password Restore page
		 */
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/change_password_page Change Password} page. 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/change_password_page Creating the Change Password page
		 ...
		 * Usually this handler used on the {@link http://lemonstandapp.com/docs/change_password_page Change Password} page,
		 ...
		 * Please read {@link http://lemonstandapp.com/docs/skipping_the_shipping_method_step_for_downloadable_products_or_services Skipping the Shipping Method step for downloadable products or services} article
		 ...
		 * </ul>
		 * Please refer to the {@link http://lemonstandapp.com/docs/automatic_customer_registration Automatic customer registration} article for the implementation details.
		 ...
		 * {@link http://lemonstandapp.com/docs/shopping_cart_price_rules/ Shop/Discounts page} page) and 
		 ...
		 * Each element in the collection is an object of the {@link Shop_Country} class.
		 * @output Db_DataCollection $states {Billing and Shipping information steps} A collection of countries for populating the State list. 
		 * Each element in the collection is an object of the {@link Shop_CountryState} class
		 ...
		 * @output float $shipping_quote {Payment method step} Specifies a shipping quote value.
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/checkout_page Creating the Checkout Page
		 ...
		 * Usually this AJAX handler used on the {@link http://lemonstandapp.com/docs/checkout_page Checkout page} together with {@link action@shop:checkout} action,
		 ...
		 * @link http://lemonstandapp.com/docs/checkout_page Creating the Checkout page
		 */
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/payment_receipt_page Payment Receipt} page. 
		 ...
		 * This action is a part of the {@link http://lemonstandapp.com/docs/implementing_the_step_by_step_checkout step-by-step checkout process}. 
		 ...
		 * Please refer to the {@link http://lemonstandapp.com/docs/automatic_customer_registration/ Automatic Customer Registration}
		 * article for details.
		 *
		 ...
		 * {@link http://lemonstandapp.com/docs/shopping_cart_price_rules/ price rules}
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/implementing_the_step_by_step_checkout Implementing the Step-By-Step Checkout
		 * @see  http://lemonstandapp.com/docs/automatic_customer_registration/ Automatic customer registration
		 * @see action@shop:checkout
		 ...
		 * Accepted values are: 0, 1. See also the {@link http://lemonstandapp.com/docs/automatic_customer_registration Automatic customer registration} article.
		 ...
		 * By default the browser is automatically redirected to the {@link http://lemonstandapp.com/docs/pay_page payment page} after the order is placed.
		 * Accepted values are: 0, 1.
		 * @input string $cart_name Specifies the shopping cart name. 
		 * LemonStand support multiple shopping cart. By default the cart named <em>main</em> used.
		 * 
		 ...
		 * and redirects the browser to the {@link http://lemonstandapp.com/docs/pay_page payment page}.
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/pay_page Payment} page. 
		 * The action loads an order by an order hash string, specified in the page URL and prepares all required
		 * PHP variables.
		 * 
		 * @action shop:pay
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/pay_page Payment page
		 */
		public function pay()
		{
		 ...
		 * {@link http://lemonstandapp.com/docs/creating_the_bank_transfer_and_other_similar_payment_methods bank transfer payment method}. 
		 * 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/creating_the_bank_transfer_and_other_similar_payment_methods Bank transfer payment method
		 * @see action@shop:pay
		 */
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/implementing_customer_payment_profiles Payment Profile} page.
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/implementing_customer_payment_profiles Payment Profiles
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/implementing_customer_payment_profiles Payment Profiles} page.
		 * 
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/customer_orders_page customer order list} page. 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/customer_orders_page Creating the Customer Orders page
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/order_details_page Order Details} page.
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/creating_the_search_page Search} page. 
		 * The action finds products in the database, according to a search query and other search parameters passed to the search 
		 * page in the URL. Please read the {@link http://lemonstandapp.com/docs/creating_the_search_page Creating the Search page} article 
		 ...
		 * the {@link http://lemonstandapp.com/docs/creating_the_search_page Creating the Search page} article.
		 * 
		 ...
		 * @output array $categories A list of category identifiers specified in the search form.
		 * @output array $manufacturers A list of manufacturer identifiers specified in the search form.
		 * @output array $option_names A list of product option names specified in the search form.
		 * @output array $option_values A list of product option values specified in the search form.
		 * @output array $attribute_names A list of product attribute names specified in the search form.
		 * @output array $attribute_values A list of product attribute values specified in the search form.
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/creating_the_search_page Creating the Search page
		 ...
		 * Read the {@link http://lemonstandapp.com/docs/implementing_the_compare_products_feature Compare Products Page} article for the 
		 ...
		 * @see http://lemonstandapp.com/docs/implementing_the_compare_products_feature Compare Products Page
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/implementing_the_compare_products_feature Compare Products} page. 
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/manufacturer_list_page/ Creating the Manufacturer List} page. 
		 * 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/manufacturer_list_page/ Creating the Manufacturer List Page
		...
		/**
		 * Base action for the {@link http://lemonstandapp.com/docs/manufacturer_list_page/ Manufacturer Details} page.
		 * The action loads a manufacturer object by its URL Name specified in the page URL.
		 * 
		 ...
		 * @author LemonStand eCommerce Inc.
		 * @package shop.actions
		 * @see http://lemonstandapp.com/docs/manufacturer_details_page/ Creating the Manufacturer Page
