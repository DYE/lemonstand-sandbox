<?php
	 ...
	 * @see http://lemonstandapp.com/docs/managing_bundle_products/ Managing bundle products
	 * @see http://lemonstandapp.com/docs/displaying_product_bundle_items/ Displaying product bundle items
	...
	class Shop_BundleItemProduct extends Db_ActiveRecord
	{
		 ...
		 * {@link http://lemonstandapp.com/docs/understanding_option_matrix/ Option Matrix} 
		 ...
		 * @param array $product_options Specifies selected product options ({@link http://lemonstandapp.com/docs/understanding_option_matrix/ Option Matrix} support)
		 ...
		 * the product assigned to the item will be used. If you use {@link http://lemonstandapp.com/docs/understanding_option_matrix/ Option Matrix} 
		 * feature, pass selected bundle item product's options to the second parameter. Use {@link Shop_BundleHelper::get_selected_options()} 
		 * method to load the selected options. Example: 
		 * <pre>
		 * $selected_options = Shop_BundleHelper::get_selected_options($item, $item_product);
