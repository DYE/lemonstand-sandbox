<?php
	 ...
	 * as well as a list of the category products. The category class is {@link http://lemonstandapp.com/docs/performance_tuning/ proxiable}.
	 *
	 ...
	 * @documentable
	 * @see http://lemonstandapp.com/docs/displaying_a_list_of_categories Displaying a list of categories
	 * @see http://lemonstandapp.com/docs/category_page Category page
	 * @package shop.models
	...
	class Shop_Category extends Db_ActiveRecord
	{
		 ...
		 * Please read the {@link http://lemonstandapp.com/docs/displaying_a_list_of_products Displaying a list of products} article for the examples.
		 * 
