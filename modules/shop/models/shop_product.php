<?php
	 ...
	 * {@link http://lemonstandapp.com/docs/product_page product details page}. Usage example:
	 * <pre>
	 ...
	 * @property boolean $disable_completely Determines whether the product and all its grouped products are disabled (overrides the {@link Shop_Product::enabled enabled} property).
	 ...
	 * @property string $meta_description Specifies the product description for outputting in the HTML META element on the {@link http://lemonstandapp.com/docs/product_page product details page}.
	 * @property string $meta_keywords Specifies the product keywords for outputting in the HTML META element on the {@link http://lemonstandapp.com/docs/product_page product details page}.
	 ...
	 * Please read the {@link http://lemonstandapp.com/docs/displaying_product_options Displaying Product Options} article for details and code examples.
	 ...
	 * {@link http://lemonstandapp.com/docs/product_page product pages}.
	 ...
	 * @see http://lemonstandapp.com/docs/displaying_a_list_of_products/ Displaying a list of products
	 * @see http://lemonstandapp.com/docs/displaying_a_list_of_grouped_products/ Displaying a list of grouped products
	 * @package shop.models
...
//			'related_product_list'=>array('class_name'=>'Shop_Product', 'join_table'=>'shop_related_products', 'primary_key'=>'master_product_id', 'foreign_key'=>'related_product_id', 'conditions'=>'shop_products.enabled=1')
		...
		*/
		 ...
		 * If there are no {@link http://lemonstandapp.com/docs/catalog_level_price_rules catalog price rules} applied to the product and there
		 * is no sale price specified for the product, the method returns the product base price. 
		 * The price can include tax if the {@link http://lemonstandapp.com/docs/configuring_lemonstand_for_tax_inclusive_environments/ Display catalog/cart prices including tax} 
		 * option is enabled
		 * 
		...
		/**
		 * Determines whether the product is on sale.
		 * Products considered on sale if there are any active {@link http://lemonstandapp.com/docs/catalog_level_price_rules catalog price rules} 
		...
		*/
		 ...
		 * For products which use {@link http://lemonstandapp.com/docs/integrating_option_matrix Option Matrix} the base product
		 ...
		 * The price depends on price tiers and does not depend on {@link http://lemonstandapp.com/docs/catalog_level_price_rules catalog price rules}. 
		...
		* to include grouped product prices into the calculations. Pass a specific customer group identifier to the <em>$customer_group_id</em> parameter 
		...
		/**
		 * Returns a {@link http://lemonstandapp.com/docs/product_page/ product page} URL, based on the URL passed in the parameter. 
		 ...
		 * {@link http://lemonstandapp.com/docs/displaying_a_list_of_products Displaying a list of products} article for the usage example.
		 * @documentable
		 * @see http://lemonstandapp.com/docs/product_page/ Product page
		 * @see http://lemonstandapp.com/docs/displaying_a_list_of_products Displaying a list of products
		 ...
		 * The <em>$default_product_url</em> parameter should contain an URL of a default {@link http://lemonstandapp.com/docs/product_page/ product page}
		 ...
		 *   can use values like "price desc".</li>
		 * </ul>
		 * Usage example: 
		 * <pre>
		...
		/**
		 * Returns a list of products on sale.
		 * Products on sale include products with any {@link http://lemonstandapp.com/docs/catalog_level_price_rules catalog price rules} applied 
		 ...
		 * The <em>$options</em> parameter allows to specify the sort mode with the <em>sorting</em> element. This element should contain an array 
		 ...
		 * @documentable
		 * @see http://lemonstandapp.com/docs/displaying_products_on_sale Displaying products on sale
		 * @param array $options Specifies the method options.
		 * @return Shop_Product Returns an object of the {@link Shop_Product} class. 
		 */
		 ...
		 * </pre>
		 * @documentable
		 * @see http://lemonstandapp.com/docs/displaying_related_products/ Displaying related products
		 * @return Shop_Product Returns an object of the {@link Shop_Product} class.
		 */
		 ...
		 * @documentable 
		 * @see http://lemonstandapp.com/docs/displaying_product_extra_options/ Displaying product extra options
		 ...
		 * This method is applicable only on the {@link http://lemonstandapp.com/docs/product_page Product Details} page. Please see
		 * {@link http://lemonstandapp.com/docs/supporting_file_uploads_on_the_product_page/ Supporting file uploads on the product page} article for details.
		 * @documentable
		 * @see http://lemonstandapp.com/docs/supporting_file_uploads_on_the_product_page/ Supporting file uploads on the product page
		...
		*      date is not set, returns null. You can format the date using the format() method. Example:
		 ...
		 * </pre>
		 * @documentable
		 * @see http://lemonstandapp.com/docs/integrating_option_matrix Integrating Option Matrix
		 ...
		 * You can download a module template extending the product model in {@link http://lemonstandapp.com/docs/lemonstand_module_templates Module Templates} 
		...
		/**
		 * Triggered before a file is added to a product on the {@link http://lemonstandapp.com/docs/product_page Product Details} page. 
		 * Inside the event handler you can validate the uploaded file and trigger an exception if it is needed. 
		 * Please read {@link http://lemonstandapp.com/docs/supporting_file_uploads_on_the_product_page/ this article} to learn about 
		...
		/**
		 * Triggered after a file is added to a product on the {@link http://lemonstandapp.com/docs/product_page Product Details} page. 
		 * Please read {@link http://lemonstandapp.com/docs/supporting_file_uploads_on_the_product_page/ this article} to learn about 
		 * implementing the file upload support on the product details page. 
		 * Example:
		 * <pre>
		 ...
		 * This event affects the {@link http://lemonstandapp.com/docs/creating_the_search_page Search Page} and 
		 * {@link Shop_Product::find_products()} method.
		 * @event shop:onRegisterProductSearchEvent
		 * @see http://lemonstandapp.com/docs/creating_the_search_page Search Page
		 * @package shop.events
		 * @author LemonStand eCommerce Inc.
