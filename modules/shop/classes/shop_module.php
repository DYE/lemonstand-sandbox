		...
		public function listSettingsItems()
		{
			$result = array(
				...
				array(
					...
					'description'=>'Setup a list of countries and states you shop to. Set ISO codes for countries and states.',
					'sort_id'=>70,
					'section'=>'eCommerce'
					),
				array(
		...
		public function listEmailVariables()
		{
			...
			return array(
				...
				'Out of stock notification'=>array(
					...
					'out_of_stock_count'=>array('Outputs the number of untis in stock', '100'),
