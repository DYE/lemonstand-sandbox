<?php
	...
	class Shop_ProductHelper
	{
		 ...
		 * set corresponding to the first <em>enabled</em> {@link http://lemonstandapp.com/docs/integrating_option_matrix Option Matrix} record. 
		 ...
		 * or POSTed when a visitor selects another option on the {@link http://lemonstandapp.com/docs/product_page/ product details} page.
		 * @documentable
