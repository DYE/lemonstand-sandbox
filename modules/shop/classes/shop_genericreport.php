<?
	...
	abstract class Shop_GenericReport extends Backend_ChartController
	{
		 ...
		 * {@link http://lemonstandapp.com/docs/list_filters/ List filters} article for details about back-end list filters.
		 ...
		 * @see http://lemonstandapp.com/docs/list_filters/ List filters
		 * @package shop.events
