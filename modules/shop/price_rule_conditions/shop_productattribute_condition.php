<?
	...
	class Shop_ProductAttribute_Condition extends Shop_ModelAttributesConditionBase
	{
		...
		public function get_value_dropdown_options($host_obj, $controller)
		{
			...
			if ($attribute == 'product')
			{
				$products = Db_DbHelper::objectArray('select id, name from shop_products where grouped is null order by name');
		...
		public function is_true(&$params, $host_obj)
		{
			...
			{
				return parent::eval_is_true($params['product'], $host_obj, $params['product']->list_categories());
			}
