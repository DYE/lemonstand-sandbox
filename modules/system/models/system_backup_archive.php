<?php
	...
	class System_Backup_Archive extends Db_ActiveRecord 
	{
		...
		/**
		 * Triggered before LemonStand {@link http://lemonstandapp.com/docs/configuring_and_using_the_backup_system archive} is created.
		 * Example:
		 * <pre>
		 ...
		 * @see http://lemonstandapp.com/docs/configuring_and_using_the_backup_system Configuring and using the backup system
		...
		/**
		 * Triggered before LemonStand {@link http://lemonstandapp.com/docs/configuring_and_using_the_backup_system archive} is restored.
		 * Example:
		 * <pre>
		 * public function subscribeEvents()
		 * {
